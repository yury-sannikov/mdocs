...
AWS_ACCESS_KEY_ID=AKIAJYVOLGU7FGP6LUHQ AWS_SECRET_ACCESS_KEY=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 aws s3 cp s3://mdocs-sitebuilder ./tmp/mdocs-sitebuilder-s3 --recursive
