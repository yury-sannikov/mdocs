        ...
        <form className="form-horizontal" action="base_forms_wizard.html" method="post">
          <div className="block-content block-content-mini block-content-full border-b">
            <div className="wizard-progress progress progress-mini remove-margin-b">
              <div className="progress-bar progress-bar-info" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style={{width: '33.3333%'}}></div>
            </div>
          </div>
          <div className="block-content tab-content">
            ...
            <div className="tab-pane fade fade-up push-30-t push-50" id="simple-classic-progress-step2">
              <div className="form-group">
                <div className="col-sm-8 col-sm-offset-2">
                  ...
                  <textarea className="form-control" id="simple-classic-progress-details" name="simple-classic-progress-details" rows="9" placeholder="Share something about yourself"></textarea>
                </div>
              </div>
            </div>
            <div className="tab-pane fade fade-up push-30-t push-50" id="simple-classic-progress-step3">
              ...
              <div className="form-group">
                <div className="col-sm-8 col-sm-offset-2">
                  <label className="css-input switch switch-sm switch-primary" for="simple-classic-progress-terms">
          ...
          <div className="block-content block-content-mini block-content-full border-t">
            <div className="row">
              <div className="col-xs-6">
                <button className="wizard-prev btn btn-default disabled" type="button"><i className="fa fa-arrow-left"></i> Previous</button>
              </div>
              <div className="col-xs-6 text-right">
                <button className="wizard-next btn btn-default" type="button" style={{display: 'inline-block'}}>Next <i className="fa fa-arrow-right"></i>
                </button>
