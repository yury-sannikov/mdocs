...
var assetsPath = path.resolve(__dirname, '../public/app/dist');
...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.less$/, loader: 'style!css?modules&importLoaders=2&sourceMap&localIdentName=[local]___[hash:base64:5]!postcss-loader?browsers=last 2 version!less?outputStyle=expanded&sourceMap' },
