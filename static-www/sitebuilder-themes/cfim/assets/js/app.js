...
$(document).ready(function() {
    ...
    $("#new-patient-yes").click(function() {
        $('input.js-bookonline[name="isnew"]').val('yes');
    })
    $("#new-patient-no").click(function() {
        $('input.js-bookonline[name="isnew"]').val('');
    })
});

// Contact Form Global fns
function contactBeforeSubmitCallback() {
...
function contactSubmitCallback(maybeError) {
    var form = $(this);
    var form_btn = form.find('button[type="submit"]');
    var success_msg = form_btn.data('success-msg');
    var error_msg = form_btn.data('error-msg');
