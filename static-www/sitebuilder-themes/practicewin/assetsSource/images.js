require('./images/abstract-bg-01.png');
require('./images/device-group.png');
require('./images/gmap-marker.png');
require('./images/icon-img-02.png');
require('./images/intro-app-img-02.png');
...
require('./images/favicons/apple-touch-icon.png');
require('./images/favicons/favicon.png');
